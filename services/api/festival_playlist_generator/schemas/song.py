...
class SongBase(BaseModel):
    ...
    original_artist: Optional[str] = Field(None, max_length=255, description="Original artist for covers")
    is_cover: bool = Field(default=False, description="Whether this is a cover song")
    performance_count: int = Field(default=0, ge=0, description="Number of times performed")
