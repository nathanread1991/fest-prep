...
class PlaylistBase(BaseModel):
    ...
    platform: Optional[StreamingPlatform] = Field(None, description="Streaming platform")
    external_id: Optional[str] = Field(None, max_length=255, description="Platform-specific playlist ID")
