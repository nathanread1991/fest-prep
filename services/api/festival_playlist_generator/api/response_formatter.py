...
class ResponseFormatter:
    ...
    def no_content_response(self, message: Optional[str] = None) -> JSONResponse:
    ...
    def validation_error_response(self, errors: Dict[str, Any]) -> JSONResponse:
    ...
    def internal_error_response(self, message: Optional[str] = None) -> JSONResponse:
