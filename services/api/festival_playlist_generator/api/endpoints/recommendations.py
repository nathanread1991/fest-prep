...
async def get_festival_recommendations(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get festival recommendations: {str(e)}")
...
async def calculate_similarity_scores(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to calculate similarity scores: {str(e)}")