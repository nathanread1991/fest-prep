...
class DuplicateDetectionService:
    ...
    def find_duplicates_for_artist(self, artist_id: str) -> Optional[DuplicateGroup]:
        ...
        for other in all_artists:
            other_normalized = name_normalization_service.normalize_for_comparison(other.name)
    ...
    def _load_artist_stats(self, artist: Artist) -> ArtistStats:
        ...
        return ArtistStats(
            ...
            name=artist.name,
            normalized_name=name_normalization_service.normalize_for_comparison(artist.name),
