...
class ColorAnalyzer:
    ...
    def extract_from_css(self, html_content: str) -> List[str]:
        ...
        style_matches = re.findall(style_tag_pattern, html_content, re.IGNORECASE | re.DOTALL)
    ...
    def rank_colors(self, colors: List[str]) -> ColorScheme:
        ...
        secondary = most_common[1][0] if len(most_common) > 1 else self._generate_complementary(primary)
