...
class TestBaseRepository:
    ...
    @pytest.mark.asyncio
    async def test_delete_existing(self, artist_repository, sample_artist, async_session):
    ...
    async def test_get_all_ids(self, artist_repository, async_session):
        ...
        for i in range(3):
            artist = Artist(
                name=f"ID Test Artist {i}",
                spotify_id=f"id_test_{i}",
                genres=["pop"]
            )
            async_session.add(artist)
            await async_session.flush()
...
class TestFestivalRepository:
    ...
    async def test_get_upcoming_festivals(self, festival_repository, async_session):
        ...
        for festival in results:
            assert festival.start_date >= datetime.utcnow().replace(hour=0, minute=0, second=0, microsecond=0)
...
class TestPlaylistRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_by_festival(self, playlist_repository, sample_festival, sample_user, async_session):
    ...
    @pytest.mark.asyncio
    async def test_get_by_artist(self, playlist_repository, sample_artist, sample_user, async_session):
    ...
    async def test_get_by_spotify_id(self, playlist_repository, sample_playlist):
        ...
        result = await playlist_repository.get_by_spotify_id(sample_playlist.external_id)
        assert result is not None
    ...
    @pytest.mark.asyncio
    async def test_get_user_festival_playlist(self, playlist_repository, sample_user, sample_festival, async_session):
    ...
    @pytest.mark.asyncio
    async def test_count_by_platform(self, playlist_repository, sample_user, async_session):
        ...
        spotify_count = await playlist_repository.count_by_platform(StreamingPlatform.SPOTIFY)
        assert spotify_count == 3
        
        youtube_count = await playlist_repository.count_by_platform(StreamingPlatform.YOUTUBE)
...
class TestSetlistRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_by_artist(self, setlist_repository, sample_artist, async_session):
    ...
    @pytest.mark.asyncio
    async def test_get_recent_setlists(self, setlist_repository, sample_artist, async_session):
        ...
        results = await setlist_repository.get_recent_setlists(sample_artist.id, from_date=from_date)
    ...
    @pytest.mark.asyncio
    async def test_count_by_artist(self, setlist_repository, sample_artist, async_session):
...
class TestUserRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_users_with_marketing_opt_in(self, user_repository, async_session):
    ...
    @pytest.mark.asyncio
    async def test_update_preferences(self, user_repository, sample_user, async_session):
    ...
    @pytest.mark.asyncio
    async def test_add_connected_platform(self, user_repository, sample_user, async_session):
    ...
    @pytest.mark.asyncio
    async def test_remove_connected_platform(self, user_repository, sample_user, async_session):
        ...
        # Then remove it
        result = await user_repository.remove_connected_platform(sample_user.id, "youtube")
        await async_session.flush()
    ...
    @pytest.mark.asyncio
    async def test_add_festival_to_history(self, user_repository, sample_user, sample_festival, async_session):
        """Test adding a festival to user history."""
        result = await user_repository.add_festival_to_history(sample_user.id, sample_festival.id)
        await async_session.flush()
...
class TestSetlistRepositoryExtended:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_with_relationships(self, setlist_repository, sample_artist, async_session):
    ...
    @pytest.mark.asyncio
    async def test_get_by_festival_name(self, setlist_repository, sample_artist, async_session):
    ...
    @pytest.mark.asyncio
    async def test_get_by_date_range(self, setlist_repository, sample_artist, async_session):
        ...
        results = await setlist_repository.get_by_date_range(start_date, end_date, artist_id=sample_artist.id)
        assert len(results) >= 1
    
    @pytest.mark.asyncio
    async def test_count_by_venue(self, setlist_repository, sample_artist, async_session):
...
class TestFestivalRepositoryExtended:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_with_relationships(self, festival_repository, sample_festival):
        """Test getting festival by ID with relationships loaded."""
        result = await festival_repository.get_by_id(sample_festival.id, load_relationships=True)
        assert result is not None
        assert result.id == sample_festival.id
...
class TestPlaylistRepositoryExtended:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_with_relationships(self, playlist_repository, sample_playlist):
        """Test getting playlist by ID with relationships loaded."""
        result = await playlist_repository.get_by_id(sample_playlist.id, load_relationships=True)
        assert result is not None
        assert result.id == sample_playlist.id
