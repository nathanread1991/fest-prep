...
class TestExceptionHandlers:
    ...
    async def test_http_exception_handler(self):
        ...
        with patch('festival_playlist_generator.api.exception_handlers.get_request_version') as mock_version:
            with patch('festival_playlist_generator.api.exception_handlers.APIVersionManager') as mock_manager:
